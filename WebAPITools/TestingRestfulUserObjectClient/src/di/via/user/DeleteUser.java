...
public class DeleteUser  implements java.io.Serializable {
    ...
    /**
     * Gets the id value for this DeleteUser.
     * 
     * @return id
     */
    public int getId() {
    ...
    /**
     * Sets the id value for this DeleteUser.
     * 
     * @param id
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://user.via.di", ">deleteUser"));
